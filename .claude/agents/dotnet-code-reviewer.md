...
Authoritative standards: `AGENTS.md`, `CLAUDE.md`, `documentation/architecture.md`, `_specs/`, and
`skills/southbay-soccer-conventions/SKILL.md`. Also check `.ai/memory/` and `.ai/lessons/`.
...
- **Tests**: identify the appropriate existing layer-specific test project and note missing
  meaningful coverage; placeholder tests do not count as verification.
