...
- [~] **M13.1** Client: app links (host `n9jabay.desolatravels.com`; entitlement, intent filter, CNAME and association files added 2026-09-16; Play app-signing SHA-256 added, DNS CNAME live, Apple capability + profile done by owner; files merged to main; deployment and physical-device link verification remain to be checked). Register the app-link host on iOS (associated domains +
