...
- [ ] **M8.STAT9c** Implement backend captain approval commands and result recording with scoped
  authorization and audit fields.
- [ ] **M9.STAT9d** Ensure profile recent form and leaderboard projections read from approved raw
  events and `MatchResult`/`TeamAssignment`, not mutable profile totals.
