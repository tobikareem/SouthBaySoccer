...
- [ ] **M11.8c** Implement the RSVP toggle: `ToggleRsvpCommand` optimistically flips `IsGoing`,
...
- [ ] **M11.8d** Wire the screen states through `StateView` (Loading / Empty / Error / Offline /
