...
public sealed class SchedulingEndpointMetadataTests
{
    ...
    [InlineData(nameof(SchedulingFunctions.GetCreateSessionDefaults), "sessions/admin/create-defaults", AuthenticationPolicies.CanManageSessions)]
    [InlineData(nameof(SchedulingFunctions.ListManagedSessions), "sessions/admin/managed", AuthenticationPolicies.CanManageSessions)]
    [InlineData(nameof(SchedulingFunctions.GetSessionForAdminEdit), "sessions/{sessionId:guid}/admin-edit", AuthenticationPolicies.CanManageSessions)]
    [InlineData(nameof(SchedulingFunctions.CreateSessionDraft), "sessions/drafts", AuthenticationPolicies.CanManageSessions)]
